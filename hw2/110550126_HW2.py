...
class LogisticRegression:
    def __init__(self, learning_rate=0.1, iteration=100, batch_size=32):
    ...
    def predict(self, X):
        res = np.dot(X, self.weights) + self.intercept
        return res
        pass
...
# Part 1: Logistic Regression
    ...
    LR = LogisticRegression(learning_rate=0.01, iteration=100)
